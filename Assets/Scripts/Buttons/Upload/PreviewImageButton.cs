...
{
    public class PreviewImageButton : MonoBehaviour
    {
        private Button _btn;
        ...
        protected void Start()
        {
            ...
            //_btn.enabled = GlobalItems.PictureBytes != null;
            _btn.onClick.AddListener(() =>
                {
                    SceneLoader.LoadScene(CreatedScene.PreviewPhoto);
                });
            _btn.gameObject.SetActive(GlobalItems.PictureBytes != null);
        }
