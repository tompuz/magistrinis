...
namespace Assets.Scripts.CloudRecognition
{
    ...
    public class SimpleCloudHandler : MonoBehaviour, ICloudRecoEventHandler
    {
        ...
        {
            MobileMessage.ShowMessage("Initialized", mCloudRecoBehaviour.CloudRecoEnabled.ToString());
        ...
        {
            MobileMessage.ShowMessage("Error", initError.ToString());
        }
        ...
        {
            MobileMessage.ShowMessage("Error", updateError.ToString());
        }
        ...
        {
            MobileMessage.ShowMessage("Found", targetSearchResult.TargetName);
