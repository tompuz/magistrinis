...
public class CloudRecoTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    private bool _showDescirption;
    private readonly Rect _labelRect = new Rect(50, 50, Screen.width - 100, 60);
    #endregion
                                    ...
                                    TrackableBehaviour.Status newStatus)
    {
        ...
        {
            _showDescirption = false;
            GlobalItems.TrackableDescription = null;
            OnTrackingLost();
        }
    }
    ...
    protected void OnGUI()
    {
        ...
        {
            //Draw label
            GUI.Label(_labelRect, GlobalItems.TrackableDescription, LabelStyle);
        }
    }
}
